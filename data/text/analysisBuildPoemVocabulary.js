...
let poemSymbols = [
	...
	{n: 1, count:20, text:"~", books: [ { "book": "artist", "count": 5 },{ "book": "birdland", "count": 5 },{ "book": "blueWindow", "count": 5 },{ "book": "fieldNotes", "count": 5 }],"vowels": {"a": 0,"e": 0,"i": 0,"o": 0,"u": 0},"nvowels": 0, "def": [ {"shortdef": [".||."],"fl": "symbol"},]},
	{n: 1, count:20, text:"!", books: [ { "book": "artist", "count": 5 },{ "book": "birdland", "count": 5 },{ "book": "blueWindow", "count": 5 },{ "book": "fieldNotes", "count": 5 }],"vowels": {"a": 0,"e": 0,"i": 0,"o": 0,"u": 0},"nvowels": 0, "def": [ {"shortdef": [".||."],"fl": "symbol"},]},
	{n: 1, count:20, text:"i", books: [ { "book": "artist", "count": 5 },{ "book": "birdland", "count": 5 },{ "book": "blueWindow", "count": 5 },{ "book": "fieldNotes", "count": 5 }],"vowels": {"a": 0,"e": 0,"i": 0,"o": 0,"u": 0},"nvowels": 0, "def": [ {"shortdef": [".||."],"fl": "symbol"},]}
	];
...
poemWords = [...poemWords,
	{"n": 1,"count": 12,"text": "i","books": [{"book": "artist","count": 5},
	{"book": "birdland","count": 5},
...
poemWords.sort( (worda,wordb) => worda.text < wordb.text );
fs.writeFile('outputWordsPoems_dictionary'+Date.now()+'.js', JSON.stringify(poemWords, null, "\t"), 'utf8', e => {console.log("done")});
books.map( book => {
	fs.writeFile('outputWordsPoems_'+book+'_dictionary_byText'+Date.now()+'.js', JSON.stringify(poemWords.filter(w=>{ return w.books.filter(b => b.book===book).length>0 }), null, "\t"), 'utf8', e => {console.log("done")});
});
poemWords.sort( (worda,wordb) => worda.n < wordb.n );
fs.writeFile('outputWordsPoems_dictionary_byN'+Date.now()+'.js', JSON.stringify(poemWords, null, "\t"), 'utf8', e => {console.log("done")});
poemWords.sort( (worda,wordb) => worda.count < wordb.count );
fs.writeFile('outputWordsPoems_dictionary_byCount'+Date.now()+'.js', JSON.stringify(poemWords, null, "\t"), 'utf8', e => {console.log("done")});


words.sort( (worda,wordb) => worda.text < wordb.text );
fs.writeFile('outputWords_dictionary_byText'+Date.now()+'.js', JSON.stringify(words, null, "\t"), 'utf8', e => {console.log("done")});
books.map( book => {
	fs.writeFile('outputWords_'+book+'_dictionary_byText'+Date.now()+'.js', JSON.stringify(words.filter(w=>{ return w.books.filter(b => b.book===book).length>0 }), null, "\t"), 'utf8', e => {console.log("done")});
});
words.sort( (worda,wordb) => worda.n < wordb.n );
fs.writeFile('outputWords_dictionary_byN'+Date.now()+'.js', JSON.stringify(words, null, "\t"), 'utf8', e => {console.log("done")});

words.sort( (worda,wordb) => worda.count < wordb.count );
fs.writeFile('outputWords_dictionary_byCount'+Date.now()+'.js', JSON.stringify(words, null, "\t"), 'utf8', e => {console.log("done")});
